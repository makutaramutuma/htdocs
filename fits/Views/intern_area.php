...
<main>
  ...
  <?php foreach ($posts as $post) : ?>
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><?=htmlspecialchars($post['area'])?></li>
  ...
  <?php endforeach;?>
      ...
      <div class="back">
        <button type="button" class="btn btn-primary mt-4 text-center" onclick="location.href='./intern.php'">戻る</button></br>
