...
<main>
  ...
  <form id="joinForm" action="message_complete.php?id=<?=$id ?>" style="width: 70%;" class="mx-auto" method="POST">
 ...
 <div class="mx-auto" style="width: 70%;">
  ...
  <button type="button" class="w-100 btn btn-secondary mx-auto" style="width: 70%;"  onclick="location.href='./company_details.php?id=<?=$id ?>'">戻る</button>
  </div>
