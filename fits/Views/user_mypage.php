...
<h2 class="mx-auto mt-3 text-center" style="width: 70%;">ユーザーマイページ</h2>
  <div class="card mt-4 mb-4 mx-auto" style="width: 70%;">
    ...
    <ul class="list-group list-group-flush">
      ...
      <li class="list-group-item"><?=htmlspecialchars($post['profile'])?></li>
    </ul>
    <button type="button" class="btn btn-primary mx-auto mt-4 mb-4" width="100%" onclick="location.href='./user_edit.php?id=<?=($post['id']) ?>'">プロフィールを編集する</button>
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group mx-auto">
									...
									<a class="btn btn-danger " href="favorite_delete.php?id=<?=($intern['id']) ?>" role="button" id="l-showBtn">削除</a>
...
<div class="select">
  <button type="button" class="btn btn-info mx-auto mb-4 mt-4" onclick="location.href='<?=$post['twitter']?>'">Twitter</button></br>
  <button type="button" class="btn btn-primary mx-auto mb-4" onclick="location.href='<?=$post['facebook']?>'">Facebook</button></br>
  <button type="button" class="btn btn-danger mx-auto mb-4 " width="70%" onclick="location.href='./user_delete.php'">アカウントを削除する</button>
